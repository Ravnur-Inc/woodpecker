...
| `CI_COMMIT_PULL_REQUEST_COMMENT`   | `config, runtime` | body of the comment that triggered the pipeline (set only for `pull_request_comment` events)                                                     | `/codereview --deep`                                                                                                            |
...
| `CI_PIPELINE_EVENT`                | `config, runtime` | pipeline event (see [`event`](../20-usage/20-workflow-syntax.md#event))                                                                          | `push`<br/>`pull_request`<br/>`pull_request_closed`<br/>`pull_request_metadata`<br/>`pull_request_comment`<br/>`tag`<br/>`release`<br/>`manual`<br/>`cron` |
...
| `CI_PREV_PIPELINE_EVENT`           | `config, runtime` | previous pipeline event (see [`event`](../20-usage/20-workflow-syntax.md#event))                                                                 | `push`<br/>`pull_request`<br/>`pull_request_closed`<br/>`pull_request_metadata`<br/>`pull_request_comment`<br/>`tag`<br/>`release`<br/>`manual`<br/>`cron` |
